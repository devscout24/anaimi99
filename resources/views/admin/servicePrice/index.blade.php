                ...
                <div class="card-body">
                    ...
                    <form id="form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" min="0" id="price" class="form-control" autocomplete="off">
                        </div>

                        <div class="mb-3">
                            <label for="discount" class="form-label">Discount</label>
                            <input type="number" step="0.01" min="0" id="discount" class="form-control" autocomplete="off">
                        </div>
